...
func createMealPrompt(mealInfo MealInfo) string {
	recipe := "Create a recipe with step-by-step instructions based on what the following items I have available, please include the estimated cook time and cost"
...
func createMealPrepPrompt() string       { return "" }
func createGroceryListPrompt() string    { return "" }
func createSpecialRequestPrompt() string { return "" }
